...
describe('/api/auth', () => {
  ...
  // testing post '/api/auth/registration-email-resending' api
  ...
  // testing post '/api/auth/registration' api
  ...
  // testing post '/api/auth/login' api
  ...
  // testing post '/api/auth/refresh-token' api
  ...
  // testing post '/api/auth/new-password' api
  it(`should return 204 for new-password if valid email and login with new password`, async () => {
    ...
    const { recoveryData } = (await UserModel.findOne({ _id: userId })) || {};
  ...
  // testing post '/api/auth/logout' api
